...
INSERT INTO `#__vm_auth_group` (`group_id`, `group_name`, `group_level`) VALUES (1, 'admin', 0),(2, 'storeadmin', 250),(3, 'shopper', 500),(4, 'demo', 750);
		
CREATE TABLE `#__vm_auth_user_group` (
...
## 
## Tabellenstruktur für Tabelle `#__vm_export`
## 

CREATE TABLE `#__vm_export` (
...
INSERT INTO `#__vm_tax_rate` VALUES (2, 1, 'CA', 'USA', 964565926, 0.0975);
