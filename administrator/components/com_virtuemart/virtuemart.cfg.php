...
define( 'URL', 'http://localhost/megafiltros.com.br/loja/' );
define( 'SECUREURL', 'http://localhost/megafiltros.com.br/loja/' );

if ( (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || $_SERVER['SERVER_PORT'] == '443' ) {
	define( 'IMAGEURL', SECUREURL .'components/com_virtuemart/shop_image/' );
	define( 'VM_THEMEURL', SECUREURL.'components/com_virtuemart/themes/megafiltros/' );
} else {
	define( 'IMAGEURL', URL .'components/com_virtuemart/shop_image/' );
	define( 'VM_THEMEURL', URL.'components/com_virtuemart/themes/megafiltros/' );
}
define( 'VM_THEMEPATH', $mosConfig_absolute_path.'/components/com_virtuemart/themes/megafiltros/' );
...
define('PSHOP_OFFLINE_MESSAGE', 'Este site está em manutenção. Por favor, retorne mais tarde.');
...
define('DOWNLOADROOT', '/Users/rafarubert/Sites/megafiltros.com.br/loja/media/');
...
define('NO_IMAGE', 'add-to-cart.gif');
define('DEBUG', '');
define('SHOWVERSION', '');
define('TAX_VIRTUAL', '');
define('TAX_MODE', '1');
